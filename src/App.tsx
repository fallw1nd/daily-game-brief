...
function App({ initialEdition = fallbackEdition, initialManifest = null, initialSearchIndex = null, initialTheme, initialAccent, initialQuery }: AppProps = {}) {
  ...
  const footerCadence = edition.period === "daily" ? "每天一期，整理值得核验的游戏行业动态。" : "每天两次，整理值得核验的游戏行业动态。";
  const footerSchedule = edition.period === "daily" ? "北京时间 12:00 更新" : "北京时间 10:10 / 17:00 更新";
