...
export default function EnglishApp() {
  ...
  const footerCadence = edition.period === "daily" ? "One evidence-checked video-game industry brief each day." : "Twice-daily, evidence-checked video-game industry news.";
  const footerSchedule = edition.period === "daily" ? "Updated at 12:00 Beijing Time" : "Updated at 10:10 / 17:00 Beijing Time";
